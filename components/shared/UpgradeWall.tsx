...
export default function UpgradeWall(_props: UpgradeWallProps) {
  ...
  return (
    <div className="border border-[#4a7c96]/40 rounded-xl p-6 bg-[#eef4f7]/80 backdrop-blur">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-[#2a2520] mb-2">See the full picture</h2>
