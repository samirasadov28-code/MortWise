...
const fr: Dictionary = {
  ...
  'wizard.stepMarket': 'Marché',
  'wizard.stepProperty': 'Bien',
  'wizard.stepProfile': 'Profil',
  'wizard.stepRateType': 'Type de taux',
  'wizard.stepScenarios': 'Scénarios',
  'misc.comingSoon': 'Bientôt disponible',
  'step3.govtSchemeSupport': 'Aides gouvernementales',
  'step3.govtSchemeHint': 'Sélectionnez un dispositif à appliquer à votre calcul. Les dispositifs ne peuvent généralement pas être cumulés — choisissez celui qui correspond à votre situation.',
  'step3.noScheme': 'Aucun dispositif',
  'step3.noSchemeDesc': 'Calculer sans aide gouvernementale',
  'step3.eligibilityPrefix': 'Éligibilité :',
  'step3.upTo': 'jusqu’à {amount}',
  'step3.lendingLimit': 'Plafond d’emprunt {market} : {limit}',
  'step3.lendingMultiple': '({multiple}× le revenu de {income})',
  'step3.withinLimit': 'Votre prêt requis ({loan}) est dans les limites.',
  'step3.exceedsLimit': 'Votre prêt requis ({loan}) dépasse le plafond habituel.',
  'step3.adjustSchemeAmount': 'Ajuster le montant (par défaut : maximum pour {scheme})',
  'step4.rateFixed': 'Taux fixe',
  'step4.rateFixedTagline': 'Certitude et prévisibilité',
  'step4.rateVariable': 'Taux variable / tracker',
  'step4.rateVariableTagline': 'Suit le marché',
  'step4.rateSplit': 'Taux mixte',
  'step4.rateSplitTagline': 'Allie stabilité et flexibilité',
  'step4.rateTracker': 'Tracker pur',
  'step4.rateTrackerTagline': 'Taux BCE / BoE + marge',
  'step4.splitRatioLabel': 'Répartition fixe / tracker',
  'step4.splitPctFixed': '{n}% fixe',
  'step4.splitPctTracker': '{n}% tracker',
  'step4.yr': 'an',
  'step4.mo': 'mois',
  'step4.cashbackAmount': 'Montant du cashback',
  'step4.clawbackYears': 'Période de remboursement (ans)',
};
